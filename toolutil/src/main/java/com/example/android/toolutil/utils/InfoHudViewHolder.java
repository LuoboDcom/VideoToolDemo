...
import com.example.android.toolutil.weight.TableLayoutBinder;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case MSG_UPDATE_HUD:
                    ...
                    //缓冲时间
                    long videoCachedDuration = mp.getVideoCachedDuration(); //视频缓冲时间
                    long audioCachedDuration = mp.getAudioCachedDuration(); //音频缓冲时间
